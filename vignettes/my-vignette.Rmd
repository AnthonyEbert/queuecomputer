...
The `server_split` function was developed to make this easier to input. We use the argument `quick = FALSE` to force `server_split()` to return a `server.list` object. 

```{r}
# server.list example

resource_schedule <- server_split(c(10,50,100), c(0, 1, 3, 1), quick = FALSE)
